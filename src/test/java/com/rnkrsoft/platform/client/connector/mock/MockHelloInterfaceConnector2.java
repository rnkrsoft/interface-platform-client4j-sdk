 ...
 */
public class MockHelloInterfaceConnector2 implements InterfaceConnector{
    ServiceConfigure serviceConfigure;

    public MockHelloInterfaceConnector2(ServiceConfigure serviceConfigure) {
    ...
    public ApiResponse call(ApiRequest request, InterfaceSetting setting) {
        ...
        String data1 = gson.toJson(helloResponse);
        response.setData(AES.encrypt("", data1));
