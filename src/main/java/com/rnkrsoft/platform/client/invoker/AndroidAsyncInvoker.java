 ...
 */
public class AndroidAsyncInvoker<Request> extends AsyncTask<Request, Void, ApiResponse> {
    ...
    public AndroidAsyncInvoker(ServiceFactory serviceFactory, String sessionId, Class service, String methodName, Class requestClass, Class responseClass, AsyncHandler asyncHandler) {
