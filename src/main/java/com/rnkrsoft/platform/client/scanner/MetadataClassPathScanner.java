...
public final class MetadataClassPathScanner {
     ...
     * @return 元信息列表
     */
    public static Map<String, Set<InterfaceMetadata>> scanClass(Collection<Class> classes) {
        Map<String, Set<InterfaceMetadata>> metadatasMap = new HashMap();
        for (Class clazz : classes) {
            ...
            Set<InterfaceMetadata> metadatas = metadatasMap.get(channel);
            if (metadatas == null) {
                metadatas = new HashSet();
                metadatasMap.put(channel, metadatas);
            }
     ...
     * @return 元信息列表
     */
    public static Map<String, Set<InterfaceMetadata>> scan(Collection<String> basePackages) {
